...
<section class="page-top-section set-bg" data-setbg="<?=base_url('public/img/fondo_libre.jpg') ?>">
    <div class="page-info">
        <h2>Formulario Workshops</h2>
        <div class="site-breadcrumb">
            <a href="">Inicio</a>  /
            <span>Formulario Workshops 2019</span>
        </div>
    </div>
</section>
<!-- Page top end-->
        ...
        <div class="row">
            <div class="col-lg-7 order-2 order-lg-1">
                <form class="contact-form" autocomplete="off">
                    ...
                    <select name="" id="select_tipo_workshop" class="form-control">
            ...
            <div class="col-lg-5 order-1 order-lg-2 contact-text text-white">
                <h3>Recordatorio</h3>
                <p>Este formulario es solo si deseas participar de alguno de los Workshops en el evento.</p>
                <div class="cont-info">
...
// Eventos
        btn_formulario.on('click', function () {
            ...
            if(es_valido){
                ...
                var request = envia_ajax("/Formulario/RegistroWorkshops", array)
                request.fail(function () {
                    swal("Alerta!", "Error al enviar Información recargue la pagina", "error");
                })
                request.done(function (data) {
                    if (data.respuesta == 'S') {
                        swal("Felicidades!", "Estas registrado , Tu Codigo de Inscripcion es el : W100"+data.data+" debes presentarlo , se envio un respaldo a tu correo.", "success");
                        LimpiarFormulario();
                    }
                    else {
                        swal({
